...
**Editor's Note** some of the following may move to Section VI depending on email over next week.
...
* [PR 44 flavors](https://github.com/oasis-tcs/osim/pull/44)
* [PR 45 component list](https://github.com/oasis-tcs/osim/pull/45)
...
* ISO placeholder discussion per email
