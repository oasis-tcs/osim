...
Note: Observers of this committee that are ready to become Members should follow the specific instructions displayed on the OASIS Open Notices tab.
...
* Action Item: (**OPEN**) Everyone to consider FAQs - especially about relationships with other work going on
* Action Item: (**OPEN**) Everyone to reread TC Charter
...
* Action Item: (**OPEN**) Everyone to think about problem space and where to focus

## V. Consent Agenda Items
The following items were circulated prior to meeting. If no objections, they will be approved (Duncan will move to accept PR's 33,2,8,6,10,34, [] seconds).
...
- [PR 34](https://github.com/oasis-tcs/osim/pull/10)
